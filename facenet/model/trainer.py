...
class FaceNetLitModule(pl.LightningModule):
    ...
    def __init__(self, 
        ...
        self.net = net
        self.criterion = TripletLoss(margin=self.hparams.metrics.train_margin)
        ...
        self.val_low_acc = AccuracyMetric(margin=self.hparams.metrics.val_margin)
        self.test_acc = EvaluationMetric(threshold=self.hparams.metrics.threshold)
